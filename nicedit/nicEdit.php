...
var nicEditorPane = bkClass.extend({
	construct : function(elm,nicEditor,options,openButton) {
        ...
        var left = this.pos[0] > $(window).width() - 270 ? $(window).width() - 285 : this.pos[0];
		
		this.contain = new bkElement('div').setStyle({zIndex : '99999', overflow : 'hidden', position : 'fixed', left : left+'px', top : '26px'})
...
var nicColorOptions = {
	buttons : {
		...
		'bgcolor' : {name : __('Change Text Background Color'), type : 'nicEditorBgColorButton', noClose : true}
	}
};
/* END CONFIG */
